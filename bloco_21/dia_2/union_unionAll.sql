...
-- a palavra "tracy" na tabela customer e os que contêm "je" na tabela actor . Exiba apenas os resultados únicos.
...
-- e atores do banco de dados, em ordem alfabética.
