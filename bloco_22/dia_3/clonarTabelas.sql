...
-- Caso não especifique qual banco de dados utilizar, 
-- a nova tabela será inserida no banco que estiver ativo 
-- no momento da execução. Sendo assim, sempre especifique o
